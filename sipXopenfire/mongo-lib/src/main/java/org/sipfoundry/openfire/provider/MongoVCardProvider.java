...
public class MongoVCardProvider implements VCardProvider {
    ...
    public Element loadVCard(String userName) {
        ...
        logger.debug(String.format("Updating cache: %s, %s)", m_userProfileService.getAvatarId(userName), userName));
        if (m_userProfileService.getAvatarId(userName) != null) {
            CacheHolder.putAvatar(m_userProfileService.getAvatarId(userName).toString(), userName);
        }
