...
public class VcardUpdateJob implements Job {
    ...
    public VcardUpdateJob(String userImName, DBObject dbObj) {
        ...
        this.newMd5 = dbObj == null ? null : dbObj.get("md5").toString();
    }

    @Override
    public void process() {
        try {
            logger.info("Processing vcard update job for " + userImName);
            ...
            if (newMd5 != null && newMd5.equals(oldMd5)) {
                ...
                VCardManager.getInstance().deleteVCard(userImName);
            } else {
    ...
    private static void updateAvatar(String username, Element vCard) throws Exception {
    ...
    private static Presence createPresenceAvatar(String aor, String itemId) throws Exception {
        ...
        UserManager um = XMPPServer.getUserManager();
